...
#     prune('f27', trainingSet)
    ...
    #Export data sets to LBJ feature files
    exportLBJFeatureFile(os.getcwd() + os.sep + 'train.column', trainingSet)
    exportLBJFeatureFile(os.getcwd() + os.sep + 'test.column', testSet)
    
    #Classify test data set
#     testsets = classifyText(trainingSet, testSet);
    
    #Export predictions for official scorer
    exportLBJPredictions(os.getcwd() + os.sep + 'outputFile', os.getcwd() + os.sep + 'output-dev.json')
