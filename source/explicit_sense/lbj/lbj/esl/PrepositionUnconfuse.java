...
// 
...
public class PrepositionUnconfuse extends SparseNetworkLearner
{
  ...
  static
  {
    _lcFilePath = PrepositionUnconfuse.class.getResource("PrepositionUnconfuse.lc");

    if (_lcFilePath == null)
    {
      System.err.println("ERROR: Can't locate PrepositionUnconfuse.lc in the class path.");
      System.exit(1);
    }

    _lexFilePath = PrepositionUnconfuse.class.getResource("PrepositionUnconfuse.lex");

    if (_lexFilePath == null)
    {
      System.err.println("ERROR: Can't locate PrepositionUnconfuse.lex in the class path.");
      System.exit(1);
    }
  }
  ...
  private static void loadInstance()
  {
    if (instance == null)
    {
      instance = (PrepositionUnconfuse) Learner.readLearner(_lcFilePath);
      instance.readLexiconOnDemand(_lexFilePath);
    }
  }

  public static Parser getParser() { return new LBJ2.parse.ArrayFileParser("/home/xuancs/lbj/lbj/esl/PrepositionUnconfuse.ex"); }
  public static Parser getTestParser() { return null; }

  public static boolean isTraining;
  public static PrepositionUnconfuse instance;

  public static PrepositionUnconfuse getInstance()
  {
    loadInstance();
    return instance;
  }

  private PrepositionUnconfuse(boolean b)
  {
    super(new Parameters());
    containingPackage = "esl";
    name = "PrepositionUnconfuse";
    setEncoding(null);
    setLabeler(new PLabel());
    setExtractor(new PrepositionUnconfuse$$1());
    isClone = false;
  }
  ...
  public PrepositionUnconfuse()
  {
    super("esl.PrepositionUnconfuse");
    isClone = true;
  }

  public PrepositionUnconfuse(String modelPath, String lexiconPath) { this(new Parameters(), modelPath, lexiconPath); }
  public PrepositionUnconfuse(Parameters p, String modelPath, String lexiconPath)
  {
    super(p);
    try {
  ...
  public void learn(Object example)
  {
    if (isClone)
    {
      if (!(example instanceof Preposition || example instanceof Object[]))
      {
        String type = example == null ? "null" : example.getClass().getName();
        System.err.println("Classifier 'PrepositionUnconfuse(Preposition)' defined on line 164 of ExplicitSense.lbj received '" + type + "' as input.");
  ...
  public void learn(Object[] examples)
  {
    if (isClone)
    {
      if (!(examples instanceof Preposition[] || examples instanceof Object[][]))
      {
  ...
  public Feature featureValue(Object __example)
  {
    if (isClone)
    {
      if (!(__example instanceof Preposition || __example instanceof Object[]))
      {
  ...
  public static void main(String[] args)
  {
    ...
    {
      System.err.println("usage: esl.PrepositionUnconfuse \\");
    ...
    PrepositionUnconfuse classifier = new PrepositionUnconfuse();
  ...
  public int hashCode() { return "PrepositionUnconfuse".hashCode(); }
  public boolean equals(Object o) { return o instanceof PrepositionUnconfuse; }
  ...
  public LBJ2.classify.ScoreSet scores(int[] a0, double[] a1, java.util.Collection a2)
  {
    if (isClone)
    {
      loadInstance();
