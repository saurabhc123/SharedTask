...
if __name__ == '__main__':
    ...
    trainRelationFilePath = '/home/development/data/conll16st-en-01-12-16-train/relations.json'
    #trainRelationFilePath = 'D:\\Test\\CS6804\\conll16st-en-01-12-16-train\\relations.json'
    trainParseFilePath = '/home/development/data/conll16st-en-01-12-16-train/parses.json'
    #trainParseFilePath = 'D:\\Test\\CS6804\\conll16st-en-01-12-16-train\\parses.json'
...
#     results = calculateRunTime(readInput, trainRelationFilePath, trainParseFilePath, 'train')
#     print '\nReading training data set DONE in', '{0:.2f}'.format(results[0]), 'Seconds'
#     #Do pruning to features in the training data set
#     pruneFeatures()    
#     #Export training data sets to LBJ feature files
#     trainFeatureFile = LBJDir + os.sep + 'trainES.column'
#     exportLBJFeatureFile(trainFeatureFile, trainingSet)
    ...
    #Train and classify test data set and produce predictions with LBJ
    #ASSUME LBJ has been installed under the LBJDir path and the LBJ jars already added to CLASSPATH !!! 
#     timeCost, LBJPredictionFile = calculateRunTime(trainAndTest, LBJDir)
#     print '\nTraining and classifying DONE in', '{0:.2f}'.format(timeCost), 'Seconds'
    ...
    updatedRelationsFile = os.getcwd() + os.sep + 'relations-updated.json'
