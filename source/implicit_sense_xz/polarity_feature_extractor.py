...
n_stemmed_word_pos_dict, y_stemmed_word_pos_dict = text_util.get_MAPA_polarity_dict()
posSet = set()
for wpTuple in n_stemmed_word_pos_dict.keys():
    posSet.add(wpTuple[1])
print "\nPOS-Set:", posSet
negate_words = text_util.get_negate_word()[0]
...
def get_polarity_features(relation, parse_dict):
    ...
    cross_product_features = text_util.cross_product_dict(features_arg1, features_arg2)
...
#     n_stemmed_word_pos_dict, y_stemmed_word_pos_dict = text_util.get_MAPA_polarity_dict()
    ...
    pos = text_util.get_MPQA_pos(pennTreePOS)
...
#             return n_stemmed_word_pos_dict[wpTuple]
    ...
    wordnet_pos = text_util.get_wordnet_pos(pennTreePOS)
...
#     word = text_util.stem_string(word)
...
#     negate_words = text_util.get_negate_word()
