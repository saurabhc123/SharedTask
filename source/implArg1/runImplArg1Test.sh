...
$curDirName/implArg1.py $relationsF $parsesF $curDirName/columnFile >$curDirName/columnFile.out 2>$curDirName/columnFile.out2
##########################
...
$curDirName/addPredictionImplArg1.py $relationsF $parsesF $testFile.res $testFile.output >a 2>b
